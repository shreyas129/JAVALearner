...
public class Main40Car {
    private boolean engine = true;
    private int cylinders, wheels = 4;
    private String name;

    public Main40Car(int cylinders, String name) {
        this.cylinders = cylinders;
        this.name = name;
    }

    public static void main(String[] args) {
        Main40Car car = new Main40Car(8, "Base car");
...
class Mitsubishi extends Main40Car {
...
class Holden extends Main40Car {
